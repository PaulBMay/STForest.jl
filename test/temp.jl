...
posparams = (beta = 5, sw1 = 5, rangeS1 = 0.2, rangeT1 = 1, sw2 = 1, rangeT2 = 0.5, tSq = 0.01)
...
priors_z = (theta0 = [1, 0.1, 1], alpha0 = [0.5, 0.5, 0.5], beta = [2 1])
...
NNGP_Bernoulli(zdata, m, zparams, priors_z, outDir, nSamps, adaptStart = 50)
